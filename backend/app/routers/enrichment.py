...
# Inventário de caminhos: vive em ``services.key_sources`` porque a correlação
# consome a mesma lista (``GET /mappings/key-sources``). Os nomes privados
# continuam existindo aqui por compatibilidade com quem os importa.
from ..services.key_sources import (  # noqa: E402
    COMMON_OCSF_KEY_PATHS as _COMMON_OCSF_KEY_PATHS,
    key_relevance as _key_relevance,
    mapped_normalized_paths as _mapped_normalized_paths,
    rule_can_be_key as _rule_can_be_key,
)
