...
Abra **Roteia → Destinos** e selecione o seu destino Datadog.
...
- **Confirmar que os dados estão chegando:** abra **Roteia → Destinos**, selecione o Datadog e veja as métricas de eventos por segundo.
