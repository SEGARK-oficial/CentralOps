...
Abra **Roteia -> Destinos** e selecione o destino Splunk HEC.
...
- **Confirmar que os dados estão chegando:** abra **Roteia -> Destinos**, selecione o Splunk HEC e veja as métricas de eventos por segundo.
