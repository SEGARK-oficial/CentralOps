...
Abra **Roteia -> Destinos** e selecione o destino ClickHouse.
...
- **Confirmar que os dados estão chegando:** abra **Roteia -> Destinos**, selecione o ClickHouse e veja as métricas de eventos por segundo.
